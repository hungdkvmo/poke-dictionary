...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/dictionary_logo.png
  AssetGenImage get dictionaryLogoPng =>
      const AssetGenImage('assets/images/dictionary_logo.png');

  /// File path: assets/images/dictionary_logo.svg
  SvgGenImage get dictionaryLogoSvg =>
      const SvgGenImage('assets/images/dictionary_logo.svg');

  /// File path: assets/images/pokeball_bg.png
  AssetGenImage get pokeballBg =>
      const AssetGenImage('assets/images/pokeball_bg.png');
  ...
  List<dynamic> get values =>
      [dictionaryLogoPng, dictionaryLogoSvg, pokeballBg, pokemonLogo];
}
